...
extraLyrics = <<
  \new Lyrics \lyricsto "verse" {
    \lyricmode {
      In a world, __ _ _ ba __ _ -- by,
      \skip 1 where the rich are __ _ poor,
      \skip 1 where the sen -- ti -- nels _ stand __ _ _ down __ _
      and the __ _ news -- pa -- per's a -- gainst the war;
    }
  }
  \new Lyrics \lyricsto "verse" {
    \lyricmode {
      ...
      a per -- fect u -- ni _ -- verse __ _ for you
  ...
  \new Lyrics \lyricsto "verse" {
    \lyricmode {
      ...
      My heart is __ _ _ _ a -- pump -- in' __ _
      a -- pump -- in' __ _ a-
  ...
  \new Lyrics \lyricsto "verse" {
    ...
    \skip 1 Ain't __ _ see -- in' much __ _ hope, __ _ _
    much hope, __ _ _ much
    \repeat unfold 8 { \skip 1 }
    hope... \skip 1 \skip 1
    O -- pen yr eyes
  }
  \new Lyrics \lyricsto "verse" {
    ...
    up in this tree
    \skip 1
    Yeah, I'm watch -- in' you,
    I'm watch -- in' you,
    I'm watch -- in' you, I'm
    \repeat unfold 8 { \skip 1 }
  ...
  \new Lyrics \lyricsto "verse" {
    ...
    \skip 1 Yr so cool, __ _ yr so cool, __ _
    yr so cool, __ _ yeah, yr
